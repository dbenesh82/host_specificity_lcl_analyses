...
setwd("../figs")
png(filename = "hostrange_vs_lcl.png", width = 500, height = 450, units = "px")
outfig
dev.off()
```
...
# want to export this figure, for use in word doc
setwd("../figs")
png(filename = "hostdissimilarity_vs_lcl.png", width = 500, height = 450, units = "px")
outfig
dev.off()
```
...
# want to export this figure, for use in word doc
setwd("../figs")
png(filename = "hostdissimilarity_vs_growth.png", width = 500, height = 450, units = "px")
outfig
dev.off()
```
